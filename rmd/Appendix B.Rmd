...
We can divide/multiply and/or add/substract an arbitrary constant value. Here, we construct a new random variably by multiplying $X$ by 10 and subsequently add 30.
