---
title: 'An example regression analysis (Data: Official Results of the
...
Check this result with the output above (the first one). After that, calculate the standard error of the slope of the second model for yourself!


## Regression parameters as random parameters

We randomly sample 100 districts from 299 all districts and draw the regression line. This is repeated for 1000 times.
